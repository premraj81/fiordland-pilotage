...
const NORTH_BOUND_WAYPOINTS = [
    { wpt: "WP002", name: "Enter dusky Sound", rad: "3.0'", crs: "073°", dist: "3.3'", spd: "16", time: "12", wo: "South Point Abeam" },
    { wpt: "WP003", name: "Anchor Island", rad: "3.0'", crs: "084°", dist: "4.3'", spd: "16", time: "16", pi: ".4 port", wo: "Conspicuous Cape Abm" },
    { wpt: "WP004", name: "Normans Island", rad: "1.0'", crs: "045°", dist: "1.2'", spd: "16", time: "5", pi: ".2 port", wo: "Thrum Cap 045" },
    { wpt: "WP005", name: "Indian Island", rad: "1.0'", crs: "075°", dist: "3.0'", spd: "16", time: "11", pi: ".23 stbd", wo: "Porpoise Pt @ .8" },
    { wpt: "WP006", name: "Duck Cove", rad: "2.0'", crs: "090°", dist: "1.2'", spd: "16", time: "5", pi: ".2 port", wo: "Porpoise Pt Abeam" },
    { wpt: "WP007", name: "Bowen Channel", rad: "1.0'", crs: "054°", dist: "2.1'", spd: "16", time: "8", pi: ".25 port", wo: "Passage Pt @ 1.0" },
    { wpt: "WP008", name: "Front Island", rad: "2.0'", crs: "007°", dist: "2.6'", spd: "16", time: "10", pi: ".2 port", wo: "Clearing Narrows" },
    { wpt: "WP009", name: "Passage Point", rad: "1.0'", crs: "356°", dist: "4.4'", spd: "16", time: "17", pi: ".28 port", wo: "Occ Cove 313, Brksea in tx" },
    { wpt: "WP010", name: "Occasional Cove", rad: "1.0'", crs: "310°", dist: "3.3'", spd: "16", time: "12", pi: ".15 stbd", wo: "Gilbert I. Abeam" },
    { wpt: "WP011", name: "Breaksea Island", rad: "1.0'", crs: "348°", dist: "4.1'", spd: "16", time: "15", pi: ".5 port" },
    { wpt: "WP012", name: "Exit Breaksea Sound", rad: "3.0'", crs: "-", dist: "30.0NM", spd: "-", time: "1h 51m" },
];

// Data for "South Bound" (Breaksea to Dusky)
const SOUTH_BOUND_WAYPOINTS = [
    { wpt: "WP012", name: "Enter Breaksea Sound", rad: "3.0'", crs: "168°", dist: "4.1'", spd: "16", time: "15", wo: "Breaksea Islet 084" },
    { wpt: "WP011", name: "Breaksea Island", rad: "1.0'", crs: "130°", dist: "3.3'", spd: "16", time: "12", pi: ".14 port", wo: "Conspicious Pt Abm Stbd" },
    { wpt: "WP010", name: "Occasional Cove", rad: "1.0'", crs: "176°", dist: "4.4'", spd: "16", time: "17", pi: ".2 port", wo: "Conspicious Cove Abm Port" },
    { wpt: "WP009", name: "Passage Point", rad: "1.0'", crs: "187°", dist: "2.6'", spd: "16", time: "10", pi: ".11 port", wo: "Conspicious Pt 207" },
    { wpt: "WP008", name: "Front Island", rad: "1.0'", crs: "234°", dist: "2.1'", spd: "16", time: "8", pi: ".23 stbd", wo: "Porpoise Pt 260" },
    { wpt: "WP007", name: "Bowen Channel", rad: "1.0'", crs: "270°", dist: "1.2'", spd: "16", time: "5", pi: ".2 stbd", wo: "Conspicious Pt 240" },
    { wpt: "WP006", name: "Duck Cove", rad: "2.0'", crs: "255°", dist: "3.0'", spd: "16", time: "11", pi: ".22, .29 stbd", wo: "Indian I. 226" },
    { wpt: "WP005", name: "Indian Island", rad: "1.0'", crs: "255°", dist: "1.2'", spd: "16", time: "5", pi: ".21 port", wo: "Thrum Cap 256" },
    { wpt: "WP004", name: "Normans Island", rad: "1.0'", crs: "264°", dist: "4.3'", spd: "16", time: "16", pi: ".43 port" },
    { wpt: "WP003", name: "Anchor Island", rad: "1.0'", crs: "253°", dist: "3.3'", spd: "16", time: "12" },
    { wpt: "WP002", name: "Exit dusky Sound", rad: "3.0'", crs: "-", dist: "30NM", spd: "-", time: "1h 51M" },
];
